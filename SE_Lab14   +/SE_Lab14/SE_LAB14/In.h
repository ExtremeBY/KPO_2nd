...
/*4*/	IN::T,	IN::T, IN::F, IN::F, IN::F,	IN::T, IN::F, IN::T, IN::F,	IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F,\
/*5*/	IN::F,	IN::F, IN::F, IN::F, IN::F,	IN::F, IN::F, IN::T, IN::I,	IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::T,\
/*6*/	IN::F,  IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::T, IN::F, IN::F, IN::F, IN::T,\
/*7*/	IN::F,	IN::F, IN::T, IN::F, IN::F,	IN::T, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F,\
...
/*F*/   IN::F,  IN::F, IN::F, IN::F, IN::F, IN::F, IN::F, IN::F,	IN::F, IN::F, IN::F, IN::F,	IN::F, IN::F, IN::F\
}
